 ...
 <script>
    	...
    	$(function(){
    			...
    			$("#checkJson").click(function(){
    				...
    				var num = document.commentForm.name.value;
    				var _jsonInfo = '{"comment":"'+comment+'","t_name":"board","ref":"'+num+'"}';
    				...
    				$.ajax({
    							...
    							success : function(data,textStatus){
    								...
    								var booksInfo = "<br><br><br>도서정보<br>=============<br>";
    								
    								for(var i in jsonInfo.books){
    									
    									booksInfo += jsonInfo.books[i].title + "<br>";
    									booksInfo += jsonInfo.books[i].writer + "<br>";
    									booksInfo += jsonInfo.books[i].price + "<br>";
    									booksInfo += jsonInfo.books[i].genre + "<br>";
